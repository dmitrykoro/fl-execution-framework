...
def calculate_distances_relation(experiment_results):
    ...
    print(f"Distance relation without bad / with bad: {distance_sum_without_bad / distance_sum_with_bad}")
    print(f"Normalized distance relation without bad / with bad: {norm_distance_sum_without_bad / norm_distance_sum_with_bad}")
