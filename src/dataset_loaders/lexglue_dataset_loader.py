...
class LexGLUEDatasetLoader:
    """
    Dataset loader for LexGLUE LEDGAR (HuggingFace: coastalcph/lex_glue).

    Dataset: Contract provision classification from U.S. SEC filings.
    ...
    def load_datasets(self):
        """
        Loads LexGLUE LEDGAR from HuggingFace and partitions into clients.
        """
        trainloaders = []
        valloaders = []
        ...
        # Load dataset from HuggingFace (LEDGAR subset)
